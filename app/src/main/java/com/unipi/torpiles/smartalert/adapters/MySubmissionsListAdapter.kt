 ...
 */
open class MySubmissionsListAdapter(
    private val context: Context,
    private var list: ArrayList<Submission>
) : RecyclerView.Adapter<MySubmissionsListAdapter.SubmissionsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SubmissionsViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            if (model.accepted)
                textViewCategory.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.svg_tick_rounded_icon, 0, 0, 0)
            else
                textViewCategory.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.svg_cross_rounded_icon, 0, 0, 0)
